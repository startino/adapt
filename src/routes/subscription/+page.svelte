<script lang="ts">
	...
	import { PRICING_TIER, createCheckoutSession, createPortalSession } from '$lib/services/stripe.service.js';
	import { Button } from '$lib/components/ui/button';
	import { CheckCircle, AlertCircle, Crown, CreditCard, UserPlus } from 'lucide-svelte';
					...
					<div class="flex flex-col items-center gap-6">
						...
						<div class="text-center max-w-md">
							...
							<Button 
								...
								href={`/signup?convert=true&redirectTo=${encodeURIComponent(redirectTo || '/subscription')}`}
							>
